...
module.exports = {
  ...
  onStart: async function ({ message, args }) {
    ...
    if (!keyword) return message.reply("Please provide a keyword. Example: #photo cat 3");
    ...
    try {
      ...
      if (images.length === 0) return message.reply("No images found for your keyword.");
